...
class Config:
    ...
    NAVER_SEARCH_ADS_API_KEY = os.getenv("NAVER_SEARCH_ADS_API_KEY", "").strip()
    NAVER_SEARCH_ADS_SECRET = os.getenv("NAVER_SEARCH_ADS_SECRET", "").strip()
    NAVER_SEARCH_ADS_CUSTOMER_ID = os.getenv("NAVER_SEARCH_ADS_CUSTOMER_ID", "").strip()
